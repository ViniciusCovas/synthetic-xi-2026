...
def canonicalize_player_identity(player_matches: pd.DataFrame) -> pd.DataFrame:
    ...
    El proveedor alterna grafías del mismo jugador entre partidos; sin
    canonicalizar, el groupby lo parte en filas separadas y diluye sus minutos.
    Se adopta el nombre del partido con más minutos (desempate: fixture más
    reciente).
    """
    sort_columns = [
