...
the reviewed source files, applies the preregistered v1.1 rules correction and
executes the generated module. The CI verifies and archives the expanded sources.
"""
